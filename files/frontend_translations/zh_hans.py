translation_strings = {
    ...
    "REMOVE": "删除",
    "Sign In": "登录",
    "If you have not created an account yet, then please":"如果你还没创建账户，请先",
    "sign up":"注册",
    "first":"首先",
    "PROCEED":"确认",
    "CANCEL":"取消",
    "You're willing to remove profile permanently":"你想永久移除账户",
    "Update":"更新",
    "Channel":"频道",
    "PROFILE":"账户",
    "You're willing to remove ":"你想删除",
    "removal":"删除",
    "permanently":"（彻底删除）",
    "right now":"现在",
    "Categories": "分类",
